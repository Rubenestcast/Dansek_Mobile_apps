...
public class PrincipalScreen_nightclubs extends AppCompatActivity {

    @Override
    protected void onCreate(Bundle savedInstanceState) {
        super.onCreate(savedInstanceState);
        setContentView(R.layout.principal_screen_nightclubs);

        // Obtener la referencia al TextView del menú (burguerMenu)
        View burguerMenu = findViewById(R.id.burguerMenu_nightclubs);
